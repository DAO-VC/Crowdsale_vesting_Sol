...
function releaseTimes() {
  return [
    new BN(Math.floor(new Date("2022-11-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2022-12-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-01-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-02-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-03-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-04-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-05-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-06-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-07-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-08-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-09-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-10-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-11-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2023-12-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-01-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-02-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-03-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-04-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-05-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-06-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-07-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-08-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-09-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-10-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-11-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2024-12-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-01-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-02-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-03-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-04-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-05-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-06-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-07-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-08-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-09-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-10-08T00:00:00Z").getTime() / 1000)),
    new BN(Math.floor(new Date("2025-11-08T00:00:00Z").getTime() / 1000)),
  ];
}
...
async function main() {
  ...
  const unlockTimes = releaseTimes();
